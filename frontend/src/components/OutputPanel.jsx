  ...
  return (
    <div className="h-full bg-white flex flex-col">
      ...
      <div className="flex-1 overflow-auto p-4">
        {output === null ? (
          <p className="text-gray-500 text-sm">Click "Run Code" to see the output here...</p>
        ) : output.success ? (
          <pre className="text-sm font-mono text-green-600 whitespace-pre-wrap">{output.output}</pre>
        ) : (
          <div>
            {output.output && (
